...
if (require.main === module) {
  const address = "0x6ebaf477f83e055589c1188bcc6ddccd8c9b131a";
  const amount = "2" + "0".repeat(18);

  const l = new Leaf(address, amount);

  console.log(l);
  console.log(l.getAddressHex());
  console.log(l.getAmountBN());
}
